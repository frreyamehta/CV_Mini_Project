...
def test(opt, model, test_dates, IMAGE_SIZE, PATCH_SIZE):
    ...
    if total_image.ndim==0:
        total_image = total_image.reshape(1, 1, 1)

    elif total_image.ndim==2:
    ...
    metadata = {
        ...
        #'transform': some_affine_transform  # optional
    }
    #save_dir = '/data/cgy/ParalSTFM/paper_images'
    save_dir = os.path.join(os.getcwd(), 'paper_images')
...
def train(opt, train_dates, test_dates, IMAGE_SIZE, PATCH_SIZE):
    ...
    model_CKPT = torch.load('LGC_best.pth', map_location='cpu')
...
def main():
    ...
    parser.add_argument('--root_dir', default='/Users/frreyamehta/Documents/CV_Lab/mini_project/Landsat_and_MODIS_data_for_the_Lower_Gwydir_Catchment_study_site-LlVje3mV-_LANDSAT_unzipped/data/LGC', help='Datasets root directory')
    parser.add_argument('--train_dir', default='/Users/frreyamehta/Documents/CV_Lab/mini_project/Landsat_and_MODIS_data_for_the_Lower_Gwydir_Catchment_study_site-LlVje3mV-_LANDSAT_unzipped/data/LGC', help='Datasets train directory')
